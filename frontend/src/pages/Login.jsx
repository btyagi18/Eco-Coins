...
//       toast.success("Login successful", "Welcome back to Clean2Earn.");
//       navigate("/dashboard");
//     } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16 relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full opacity-15"
          style={{ background: 'radial-gradient(circle, rgba(13,148,136,0.3) 0%, transparent 70%)', filter: 'blur(80px)' }}
        />
      </div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 text-sm mt-1">Sign in to your Clean2Earn account</p>
          </div>
